...
finalcol[:,0]=(	0.6*(ypredproba_all[0][:,0] * ypredconfprob_all[0][0][0] + ypredproba_all[0][:,1] * ypredconfprob_all[0][0][1] ) +
...
finalcol[:,1]=( 0.6*(ypredproba_all[0][:,1] * ypredconfprob_all[0][1][1] + ypredproba_all[0][:,0] * ypredconfprob_all[0][1][0] ) +
