...
temp[:,0]=(ypredproba_all[0][:,0]*ypredproba_all[0][0][0] +# ypredproba_all[0][:,0]*ypredconfprob_all[0][0][1]+     
    ypredproba_all[1][:,0]*ypredproba_all[1][0][0] + #ypredproba_all[1][:,0]*ypredconfprob_all[1][0][1]+       
    ypredproba_all[2][:,0]*ypredproba_all[2][0][0] #+ ypredproba_all[2][:,0]*ypredconfprob_all[2][0][1]
    )

temp[:,1]=(ypredproba_all[0][:,1]*ypredproba_all[0][1][0] + #ypredproba_all[0][:,1]*ypredconfprob_all[0][1][1]+        
    ypredproba_all[1][:,1]*ypredproba_all[1][1][0] + #ypredproba_all[1][:,1]*ypredconfprob_all[1][1][1]+        
    ypredproba_all[2][:,1]*ypredproba_all[2][1][0] #+ ypredproba_all[2][:,1]*ypredconfprob_all[2][1][1]
    )
