# -*- coding: utf-8 -*-
"""
Created on Thu Mar 19 22:54:01 2020
...
comb1 = (list(combinations([0,1, 2, 3], 1) ))
...
for i in range(comb.shape[0]):    
    ...
    print(propconfmat)
    ypredconfprob_all.append(propconfmat)
...
for i in range(xtest.shape[0]):
    ...
    for j in range(comb.shape[0]): # classifiers
        print(ypredproba_all[j][i][c]) # predicted probability
        print(ypredconfprob_all[j][c][c]) #confusion mat
